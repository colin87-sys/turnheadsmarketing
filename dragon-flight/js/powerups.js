...
// Blue speed orbs: a free temporary speed burst, placed off the easy route.
const orbs = [];

export function createPowerups(scene, layout) {
  const geo = new THREE.SphereGeometry(0.7, 16, 12);
  const glowTex = makeGlowTexture('80,170,255');
  for (const p of layout.orbs) {
